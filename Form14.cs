...
namespace Günessistemioyun
{
    public partial class Form14 : Form
    {
        ...
        private void gezegen5_Click_1(object sender, EventArgs e)
        {
            if (currentAudioDevice?.PlaybackState != PlaybackState.Playing)
            {
        ...
        private void gezegen4_Click_1(object sender, EventArgs e)
        {
            if (currentAudioDevice?.PlaybackState != PlaybackState.Playing)
            {
        ...
        private void gezegen6_Click_1(object sender, EventArgs e)
        {
            if (currentAudioDevice?.PlaybackState != PlaybackState.Playing)
            {
        ...
        private void gezegen7_Click_1(object sender, EventArgs e)
        {
            if (currentAudioDevice?.PlaybackState != PlaybackState.Playing)
            {
        ...
        private void gezegen3_Click_1(object sender, EventArgs e)
        {
            if (currentAudioDevice?.PlaybackState != PlaybackState.Playing)
            {
        ...
        private void gezegen2_Click_1(object sender, EventArgs e)
        {
            if (currentAudioDevice?.PlaybackState != PlaybackState.Playing)
            {
        ...
        private void gezegen8_Click_1(object sender, EventArgs e)
        {
            if (currentAudioDevice?.PlaybackState != PlaybackState.Playing)
            {
